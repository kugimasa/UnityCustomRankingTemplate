        ...
        query.FindAsync((List<NCMBObject> objList, NCMBException e) =>
        {
            ...
            if (e == null)
            {
                ...
                for (int i = 0; i < objList.Count; i++)
                {
                    ...
                    rectTrans.sizeDelta = new Vector2(rectTrans.sizeDelta.x, rectTrans.sizeDelta.y + _scrollPadding);
                    ...
                    record.SetRecord(objList[i][UserNameKey].ToString(), Convert.ToInt32(objList[i][HighScoreKey]), rank, isMyRecord);
                    _records.Add(record);
                    _statusText.text = "";
                }
            } 
